...
public class Validator {
	...
	public void checkStringForParseInt(String data) throws InvalidInputDataException {
	...
	public void CheckNumberForGreaterThanZero(int data) throws InvalidInputDataException {
		if (data <= 0) {
	...
	public void checklengthOfString(String data) throws InvalidInputDataException {
	...
	public void checkStringOnly(String data) throws InvalidInputDataException {
		boolean result = false;
	...
	public void CheckNumberForGreaterThanZero(float data) throws InvalidInputDataException {
		if (data < 0)
			throw new InvalidInputDataException("please enter value greater than zero");

	}

	public void checkEmail(String data) throws InvalidInputDataException {
		boolean result = false;
	...
	public void checkJobId(String data) throws InvalidInputDataException {
		boolean result = false;
	...
	public boolean checkDateFormat1(String data) throws InvalidInputDataException {
		boolean result = false;
		int len = data.length();
	...
	public void validateDate(String data) throws InvalidInputDataException {
	...
	public void checkDate(String date) throws InvalidInputDataException {
	...
	public void checkHireDate(String date) throws InvalidInputDataException {
	...
	public void checkDOB(String date) throws InvalidInputDataException {
	...
	public void checkAppointmentDate(String date) throws InvalidInputDataException {
	...
	public void checkFloat(String data) throws InvalidInputDataException{
		String pattern="^[0-9]+(.[0-9]*)?$";
		if (!match(pattern, data))
			throw new InvalidInputDataException("please enter Integer or decimal number");
	}

	public boolean match(String pattern, String date) {
		Pattern patt = Pattern.compile(pattern);
